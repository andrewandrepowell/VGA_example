...
reset_run()
{
  files_to_remove=(ucli.key BoardDesign_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc BoardDesign_0_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.BoardDesign_0 xil_defaultlib.glbl -o BoardDesign_0_simv
}
...
simulate()
{
  ...
  ./BoardDesign_0_simv $opts -do simulate.do
}
# Script usage
usage()
{
