...
/* Definitions for driver VGA */
#define XPAR_VGA_NUM_INSTANCES 1

/* Definitions for peripheral VGA_0 */
#define XPAR_VGA_0_DEVICE_ID 0
#define XPAR_VGA_0_S_AXI_CONFIG_BASEADDR 0x43C00000
#define XPAR_VGA_0_S_AXI_CONFIG_HIGHADDR 0x43C0FFFF
